...
angular.module('BeerApp')
        .controller('kendoCtrl', function($scope){
            ...
            $scope.titles = [{Title : "VP"}, {Title : "CFO"}, {Title : "COO"}, {Title : "President"}, {Title : "Owner"}]                        
            ...
            $scope.mainGridOptions = {
                ...
                columns: [{
                    ...
                    field: "Title", editor: titleDropDownEditor, values: $scope.titles
                }]
            };

            function titleDropDownEditor(container, options) {
                    $('<input name="' + options.field + '" style="width: 200px"/>')
                        .appendTo(container)
                        .kendoDropDownList({
                            dataTextField: "Title",
